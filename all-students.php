  ...
  <div class="menu-area">
    ...
    <ul class="home-menu">
      ...
      <li><a href="profile.php">My_Profile</a></li>
        ...
        <li class="active"><a href="all-students.php">Student Panel</a></li>
...
<div class="container">
    ...
    <div class="row">
        <?php 
  $sql_user = "SELECT * FROM registration";
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
              <div class="student-image">
                <img src="img/userimg/<?php echo $row->u_image; ?>" alt="">
              </div>
              <div class="card-body">
                <a href="std_profile.php?std_id=<?php echo $row->st_user; ?>" class="student-name"><?php echo $row->uname; ?></a>
                <p class="card-text">
